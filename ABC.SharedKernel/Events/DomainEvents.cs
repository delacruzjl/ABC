...
public record ObservationStarted(Guid Id, Guid? ChildId, DateTime StartedAt, DailyContext? DailyContext = null) : IDomainEvent;
...
public record DailyContextUpdated(Guid Id, DailyContext? DailyContext) : IDomainEvent;
